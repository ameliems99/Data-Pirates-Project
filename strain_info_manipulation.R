...
untar("./SNP-alignment-largeDataset+Spar.tgz") #this is the file from Github (everyone should have in project folder)
Fastfile = read.fasta("./SNP-alignment-largeDataset+Spar/chrI_SNP_scere_largeDataset+Spar.fasta")  #this is the output of untar
